...
GetTRS <- function(blastfile,genomefile) {
  ...
  ####get location
  blastout <- read.delim(blastfile,sep = "\t",header = FALSE)
  colnames(blastout) <- c("species","qseqid","sseqid", "pident","length", "mismatch","gapopen", "qstart", "qend", "sstart", "send", "evalue", "bitscore", "slen", "stitle")
